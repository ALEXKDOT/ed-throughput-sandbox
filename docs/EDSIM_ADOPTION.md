...
| Clickable patients with event history                    | **Adopt**                 | Map/census selection pins a synthetic patient, separates location from concurrent status, and lists recent patient events                                                                   | Directly supports visual understanding                                                   |
...
| Scenario settings                                        | **Adopt with disclosure** | Demand, main rooms, additive fast track, hallway, care duration, CT, lab, boarding, and inpatient delay; each control states its modeled effect                                             | Documents the assumptions used in each comparison                                        |
...
| Replication results                                      | **Adopt**                 | Eight ensemble metrics, paired deltas, hourly uncertainty band, selected representative provenance, CSV comparison report                                                                   | Connects “what happened” to “how variable was it?”                                       |
| Guided setup                                             | **Adapt**                 | Set assumptions → Run → Replay & inspect guidance plus baseline-to-intervention copying                                                                                                     | Enough orientation without a mandatory wizard                                            |
...
- Map, scenario settings, KPIs, census/inspectors, and results: `src/visualizer/`
