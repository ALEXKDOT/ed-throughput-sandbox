...
Treatment and diagnostic durations use a conditional truncated lognormal transform driven by patient/stage-keyed uniforms. Non-boarding services are bounded to 1–1,440 minutes; aggregate inpatient delay is bounded to 1–4,320 minutes. The global care-duration scale applies to triage, treatment, diagnostics, reassessment, and discharge-lounge time, but deliberately does not alter inpatient delay. Numerical defaults are illustrative synthetic parameters.

Pathway and diagnostic assignment are fixed synthetic rules, not fitted clinical probabilities. Behavioral health is assigned to 8% of arrivals. Among ESI 4–5 arrivals, minor injury accounts for the next 44%; among ESI 1–3, it accounts for the next 20%. Abdominal accounts for the next 10% or 34%, respectively, and the remainder is medical. Lab probabilities are 86% for abdominal, 70% for medical, 32% for behavioral health, and 12% for minor injury. Minor injury requests X-ray with 68% probability; medical requests CT with 52% probability at ESI 1–2 and 30% otherwise; abdominal requests CT with 46% and ultrasound with 34% probability; medical and behavioral-health pathways request MRI with 4.5% probability. Selected services run sequentially in the fixed generated order.
